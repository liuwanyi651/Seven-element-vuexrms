<template>
  <div>
    <el-menu default-active="index" router @open="handleOpen" @close="handleClose" v-for="(item, index) in menus" :key="index" unique-opened>
      <!--一级菜单--->
      <el-submenu index="1">
        <!--一级菜单的模板区域-->
        <template slot="title">
...
export default {
  ...
  data() {
    return {
      icon1:['el-icon-tickets','el-icon-edit', 'el-icon-film','el-icon-coin','el-icon-shopping-cart-full'
