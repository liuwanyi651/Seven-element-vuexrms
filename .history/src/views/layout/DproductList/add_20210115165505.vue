      ...
      >
        ...
        >
          <el-tab-pane label="基本信息" name="0">
            ...
            <el-button type="success" size="mini">下一步</el-button>
          </el-tab-pane>
          <el-tab-pane label="商品参数" name="1">
            <!-- 渲染表单的item项 -->
            <el-form-item
              :label="item.attr_name"
              v-for="item in paraslist"
              :key="item.attr_id"
            >
              <!-- 复选框 -->
...
export default {
  ...
  components: {},
  methods: {
    ...shopActions(["getCateList", "getParameterList", "getParameterListName"]),
    // 级联选择器选中项变化，会触发这个函数
    handleChange() {
  ...
  computed: {
    ...shopState(["goodlist", "paraslist", "paraslistName"]),
    cateId() {
      if (this.addForm.goods_cat.length === 3) {
