<template>
    ...
    <el-card>
      ...
      <el-tabs v-model="activeName" @tab-click="handleTabClick">
        ...
        <el-tab-pane label="动态参数" name="many">
          <!-- 添加参数的按钮 -->
          <el-button type="primary" size="mini" :disabled="isBtnDisabled" @click="addManyDialogVisible = true">添加参数</el-button>
           <!-- 动态参数数据 -->
  ...
  <span slot="footer" class="dialog-footer">
    ...
    <el-button type="primary" @click="addManyDialogVisible = false">确 定</el-button>
  </span>
</el-dialog>
    </el-card>
  </div>
