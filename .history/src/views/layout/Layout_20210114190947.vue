<template>
  <div style="height: 100%">
    ...
    <div class="contentContainer">
      ...
      <div class="main">
        <div class="df">
          <draggable v-model="navtitlelist" draggable=".contrigtopone">
            <transition-group class="contrighttop">
              <div
                class="one"
              ...
              >
                ...
                <div
                  ...
                  :class="activename == item.path ? 'eee' : 'aaa'"
                >
...
export default {
  ...
  methods: {
    ...
    del(e) {
      ...
      this.rigtarr.splice(e, 1);
      // this.jump({path:this.activename})
