                ...
                >
                  ...
                  <el-col :span="18">
                    <el-tag
                      ...
                      :key="index3"  closable @close="removeRightById(scope.row,item3.id,index1,index2,index3)"
                    >
                      {{ item3.authName }}
                    </el-tag>
                  </el-col>
...
export default {
  ...
  methods: {
    ...
    // 根据id 删除对应的权限
    async removeRightById(roleId,did,ri,i,ia,){
      
      console.log('xid',roleId,)
      console.log('juti',did,)
      console.log('one',ri,)
      console.log('two',i,)
