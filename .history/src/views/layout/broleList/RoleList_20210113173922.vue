          ...
          <template slot-scope="scope">
            ...
            >
              ...
              <el-col :span="5">
                <el-tag closable
                      @close="
                        removeRightById(scope.row, item1.id,scope.$index, index1, index2, index3)
                      ">
                  {{ item1.authName }}
                </el-tag>
                ...
                >
                  <el-col :span="6">
                    <el-tag type="success" closable
                      @close="
                        removeRightById(scope.row, item2.id,scope.$index, index1, index2, index3)
                      ">
                      {{ item2.authName }}
                    </el-tag>
                    <i class="el-icon-caret-right"></i>
                  ...
                  <el-col :span="18">
                    <el-tag
                      ...
                      closable
                      @close="
                        removeRightById(scope.row, item3.id,scope.$index, index1, index2, index3)
                      "
                    >
                      {{ item3.authName }}
                    </el-tag>
