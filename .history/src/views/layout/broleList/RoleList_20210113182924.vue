<template>
  <div>
        ...
        <el-table-column label="操作" width="300px">
          <template slot-scope="scope">
            ...
            <el-tooltip
              ...
              :enterable="false"
            >
              <el-button type="warning" size="mini" @click="showSetRightDialog"
                >分配权限</el-button
              >
            </el-tooltip>
          </template>
    ...
    >
      <!--分配权限主体部分 树形控件 -->
      <el-tree :data="rightstree" :props="treetProps"  show-checkbox node-key="id" default-expand-all></el-tree>
      <!--分配权限 底部 取消 确定 -->
      <span slot="footer" class="dialog-footer">
